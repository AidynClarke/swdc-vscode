...
// const websocketStream = createWriteStream("websocket.log", { flags: "w" });
...
const SERVER_PING_INTERVAL_MILLIS =
	DEFAULT_PING_INTERVAL_MILLIS + ONE_MIN_MILLIS;
...
export function initializeWebsockets() {
	...
	// 		`${JSON.stringify({ type: "out", data: data.toString() })}\n`,
	// 	);
	// 	console.error("out", data.toString());
	// 	logIt(`websocket message out: ${data.toString()}`);
	// 	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
	// 	origSend(data, cb as any);
	// };
	...
	// 	websocketStream.write(
	// 		`${JSON.stringify({ type: "in", data: data.toString() })}\n`,
	// 	);
	// 	console.error("in", data.toString());
	// 	logIt(`websocket message in: ${data.toString()}`);
	...
	// 	"unexpected-response",
	// 	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
	// 	function unexpectedResponse(request: any, response: any) {
...
// 					try {
// 						logIt(`Flow score: ${JSON.stringify(message.body.flowScore)}`);
// 					} catch (e) {}
...
// 			case "flow_state":
// 				try {
// 					logIt(`Flow state: ${JSON.stringify(message.body)}`);
// 				} catch (e) {}
...
// 				try {
// 					logIt(`Current day stats: ${JSON.stringify(message.body.data)}`);
// 				} catch (e) {}
